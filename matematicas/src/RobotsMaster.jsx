    ...
    <section className="info-section" style={{ background: 'rgba(0, 242, 255, 0.05)', padding: '5rem 10%', borderRadius: '60px', border: `2px solid ${ROBOT_UI.primary}33`, marginTop: '4rem' }}>
      ...
      <div style={{ display: 'flex', gap: '30px', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'flex-start' }}>
        <div style={{ flex: 1, minWidth: '300px', background: '#0a0a0a', padding: '2rem', borderRadius: '20px', border: `1px solid ${ROBOT_UI.primary}66` }}>
          ...
          <input type="file" accept="image/*" onChange={handleImageUpload} style={{ display: 'block', marginBottom: '1rem', width: '100%', padding: '10px', background: '#1e293b', border: `1px solid ${ROBOT_UI.primary}44`, borderRadius: '8px', color: '#fff' }} />
          ...
          <video ref={videoRef} style={{ width: '100%', borderRadius: '10px', display: selectedImage ? 'none' : 'block' }} autoPlay playsInline muted></video>
...
const IndustrialAvocadoDashboard = () => {
  ...
  return (
    <div className="industrial-dashboard" style={{
      ...
      {/* HEADER / ALERTS - Sustitución de Lucide por Emojis */} {/* Corregido: Se mantiene el comentario original */}
...
const HeavyExcavatorArmSVG = ({ size = 500 }) => {
  const red = "#ef4444"; // Color rojo para el excavador
  return (
  ...
  public:
    ...
    void safetyProtocol() {
      ...
      <div style={{ flex: 1, minWidth: '300px', display: 'flex', justifyContent: 'center' }}>
        <HeavyExcavatorArmSVG size={500} /> {/* Se mantiene el tamaño base para el componente */}
      </div>
    </div>
  </section>
);
...
const RobotsMaster = () => {
  ...
  return (
    <div className="home-container" style={{ background: ROBOT_UI.bg, color: '#fff', paddingBottom: '100px' }}>
      ...
      {/* --- UNIDAD DE REPLICACIÓN DOCUMENTAL --- */}
      <DocumentReplicationUnit />
